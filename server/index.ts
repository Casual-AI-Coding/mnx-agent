...
function applyApiMiddlewareChain(prefix: string) {
  app.use(prefix, auditContextMiddleware)
...
// Deprecation notice for legacy /api routes
app.use('/api', (req, res, next) => {
  res.setHeader('Deprecation', 'true')
  res.setHeader('Sunset', 'Sun, 01 Jun 2027 00:00:00 GMT')
  next()
})
...
for (const prefix of API_PREFIXES) {
  ...
  app.use(prefix + '/image', imageRouter)
  app.use(prefix + '/music', musicRouter)
  app.use(prefix + '/lyrics', lyricsRouter)
  app.use(prefix + '/video', videoRouter)
  app.use(prefix + '/video-agent', videoAgentRouter)
  app.use(prefix + '/voice-mgmt', voiceMgmtRouter)
  app.use(prefix + '/files', fileRouter)
  app.use(prefix + '/usage', usageRouter)
  app.use(prefix + '/capacity', capacityRouter)
  app.use(prefix + '/cron', cronRouter)
  app.use(prefix + '/media', mediaRouter)
  app.use(prefix + '/materials', materialsRouter)
  app.use(prefix + '/prompts', promptsRouter)
  app.use(prefix + '/templates', templatesRouter)
  app.use(prefix + '/workflows', workflowsRouter)
  app.use(prefix + '/admin/service-nodes', adminServiceNodesRouter)
  app.use(prefix + '/admin/workflows', adminWorkflowsRouter)
  app.use(prefix + '/admin/service-permissions', adminServicePermissionsRouter)
