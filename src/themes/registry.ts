...
export const THEME_REGISTRY: ThemeMeta[] = [
  ...
  { id: 'dracula', name: 'Dracula', category: 'dark', icon: '🧛',
    preview: { background: '231 15% 18%', primary: '326 100% 74%' } },
  { id: 'nord', name: 'Nord', category: 'dark', icon: '🧊',
    preview: { background: '220 17% 17%', primary: '194 100% 43%' } },
  { id: 'monokai', name: 'Monokai', category: 'dark', icon: '💫',
    preview: { background: '240 20% 10%', primary: '60 100% 50%' } },
  { id: 'solarized-dark', name: 'Solarized Dark', category: 'dark', icon: '🌆',
    preview: { background: '193 100% 7%', primary: '45 100% 71%' } },
  { id: 'github-dark', name: 'GitHub Dark', category: 'dark', icon: '🐙',
    preview: { background: '210 10% 8%', primary: '203 100% 32%' } },
  { id: 'one-dark', name: 'One Dark', category: 'dark', icon: '🦇',
    preview: { background: '220 13% 15%', primary: '142 100% 48%' } },
  { id: 'tokyo-night', name: 'Tokyo Night', category: 'dark', icon: '🗼',
    preview: { background: '240 15% 8%', primary: '355 85% 60%' } },
  { id: 'purple-haze', name: 'Purple Haze', category: 'dark', icon: '🔮',
  ...
  { id: 'solarized-light', name: 'Solarized Light', category: 'light', icon: '🌅',
    preview: { background: '44 87% 94%', primary: '45 100% 71%' } },
  { id: 'notion-light', name: 'Notion Light', category: 'light', icon: '📝',
    preview: { background: '0 0% 100%', primary: '217 91% 60%' } },
  { id: 'material-light', name: 'Material Light', category: 'light', icon: '💎',
    preview: { background: '210 40% 98%', primary: '217 91% 60%' } },
  { id: 'paper-white', name: 'Paper White', category: 'light', icon: '📄',
    preview: { background: '40 30% 98%', primary: '200 50% 50%' } },
  { id: 'warm-light', name: 'Warm Light', category: 'light', icon: '🌞',
    preview: { background: '30 50% 95%', primary: '217 91% 60%' } },
  { id: 'cool-light', name: 'Cool Light', category: 'light', icon: '❄️',
    preview: { background: '210 30% 96%', primary: '195 100% 45%' } },
  { id: 'rose-light', name: 'Rose Light', category: 'light', icon: '🌹',
    preview: { background: '340 30% 96%', primary: '340 80% 50%' } },
  { id: 'mint-light', name: 'Mint Light', category: 'light', icon: '🌿',
